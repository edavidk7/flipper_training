...
from flipper_training.experiments.grad.common import (
    prepare_env,
...
from config import GradientExperimentConfig, OmegaConf
...
def train_step_to_log(rollout_td: "TensorDict", grad_norm: torch.Tensor, optim: torch.optim.Optimizer) -> dict[str, float]:
    """
...
class GradientTrainer:
    def __init__(self, config: "DictConfig"):
        self.config = GradientExperimentConfig(**config)
        ...
        self.term_logger = get_terminal_logger("grad_train")
    ...
    def _train(self):
        ...
        for i, tensordict_data in enumerate(self.collector):
            ...
            self.scheduler.step()
            log = train_step_to_log(tensordict_data, grad_norm, self.optim)
